...
Partial Public Class RadioChannelDay
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = String.Format("waRadioChannel{0}_{1}", channelID, day)
    ...
    Private Function DisplayChannelPrograms(ByVal channelID As String, ByVal day As String) As String
        ...
        Dim channel As TvDatabase.Channel = uWiMP.TVServer.RadioChannels.GetRadioChannelByChannelId(CInt(channelID))
        ...
        If channel.IsRadio And channel.VisibleInGuide Then
            Do While guideStart <= guideEnd
                ...
                If Not idLastProgram = idCurrentProgram And idCurrentProgram <> -1 Then
                    ...
                    Else
                        scheduled = ""
                    End If
                    markup += String.Format("<li><a {3} href=""RadioGuide/RadioProgram.aspx?program={0}#_RadioProgram{0}"" rev=""async"">{1}<small><br/>{2}</small></a></li>", idCurrentProgram.ToString, currentProgram.Title.ToString, currentProgram.StartTime.ToShortTimeString, scheduled)
