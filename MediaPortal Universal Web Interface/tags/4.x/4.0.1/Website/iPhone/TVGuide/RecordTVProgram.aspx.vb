...
Partial Public Class RecordTVProgram
    ...
    Private Function DisplayRecordProgramMenu(ByVal wa As String, ByVal programID As String) As String
        ...
        markup += String.Format("<li><a href=""TVGuide/RecordTVProgramConfirm.aspx?program={0}&rectype={1}#_RecordConfirm{0}"" rev=""async"">{2}</a></li>", programID, CInt(uWiMP.TVServer.Recordings.RecordingType.Once), GetGlobalResourceObject("uWiMPStrings", "once"))
        markup += String.Format("<li><a href=""TVGuide/RecordTVProgramConfirm.aspx?program={0}&rectype={1}#_RecordConfirm{0}"" rev=""async"">{2}</a></li>", programID, CInt(uWiMP.TVServer.Recordings.RecordingType.AtThisTimeEveryDay), GetGlobalResourceObject("uWiMPStrings", "at_this_time_every_day"))
        markup += String.Format("<li><a href=""TVGuide/RecordTVProgramConfirm.aspx?program={0}&rectype={1}#_RecordConfirm{0}"" rev=""async"">{2}</a></li>", programID, CInt(uWiMP.TVServer.Recordings.RecordingType.AtThisTimeEveryWeek), GetGlobalResourceObject("uWiMPStrings", "at_this_time_every_week"))
        markup += String.Format("<li><a href=""TVGuide/RecordTVProgramConfirm.aspx?program={0}&rectype={1}#_RecordConfirm{0}"" rev=""async"">{2}</a></li>", programID, CInt(uWiMP.TVServer.Recordings.RecordingType.EachTimeOnThisChannel), GetGlobalResourceObject("uWiMPStrings", "each_time_on_this_channel"))
