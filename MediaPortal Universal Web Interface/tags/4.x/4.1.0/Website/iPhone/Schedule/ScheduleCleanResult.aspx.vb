...
Partial Public Class ScheduleCleanResult
    ...
    Private Function CleanSchedules(ByVal wa As String) As String
        ...
        markup += String.Format("<a href=""Schedule/MainMenu.aspx#_Schedules"" rev=""async"" rel=""Back"" class=""iButton iBClassic"">{0}</a></li>", GetGlobalResourceObject("uWiMPStrings", "back"))
        markup += "</div>"
