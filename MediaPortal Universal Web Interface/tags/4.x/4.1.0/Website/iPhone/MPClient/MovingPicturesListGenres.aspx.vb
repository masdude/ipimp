...
Partial Public Class MovingPicturesListGenres
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waMovingPicturesListGenres"
        ...
        xw.WriteCData(DisplayMovingPicturesGenres(friendly))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayMovingPicturesGenres(ByVal friendly As String) As String
        ...
        markup += String.Format("<h3>{0} - {1}</h3>", friendly, GetGlobalResourceObject("uWiMPStrings", "movingpictures_genre"))
        markup += "<ul class=""iArrow"">"

        For Each filter As String In filters
            If filter <> "" Then markup += String.Format("<li><a href=""MPClient/MovingPicturesList.aspx?friendly={0}&filter=genre&value={1}&start=0#_MovingPicturesMovies{1}"" rev=""async"">{1}</a></li>", friendly, filter)
        Next
