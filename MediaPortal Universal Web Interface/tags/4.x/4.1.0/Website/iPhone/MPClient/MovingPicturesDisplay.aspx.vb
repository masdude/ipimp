...
Partial Public Class MovingPicturesDisplay
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = String.Format("waMovingPicturesVideo{0}", movieID)
    ...
    Private Function DisplayMyVideoMenu(ByVal wa As String, ByVal friendly As String, ByVal movieID As String) As String
        ...
        markup += String.Format("<li><a href=""MPClient/MovingPicturesPlay.aspx?friendly={0}&ID={1}#_MovingPicturesPlayVideo"" rev=""async"">{2}</a></li>", friendly, movieID, GetGlobalResourceObject("uWiMPStrings", "play"))
        markup += String.Format("<li><a href=""MPClient/MovingPicturesCoverArt.aspx?friendly={0}&ID={1}#_MovingPicturesCoverArt{1}"" rev=""async"">{2}</a></li>", friendly, movieID, GetGlobalResourceObject("uWiMPStrings", "cover_art"))
