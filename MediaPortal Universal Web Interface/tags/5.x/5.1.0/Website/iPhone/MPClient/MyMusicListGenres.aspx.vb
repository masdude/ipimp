...
Partial Public Class MyMusicListGenres
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waMyMusicListGenres"
        ...
        xw.WriteCData(DisplayMyMusicGenres(friendly))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayMyMusicGenres(ByVal friendly As String) As String
        ...
        markup += String.Format("<h3>{0} - {1}</h3>", friendly, GetGlobalResourceObject("uWiMPStrings", "music_by_genre"))
        markup += "<ul class=""iArrow"">"

        For Each filter As String In filters
            If filter <> "" Then markup += String.Format("<li><a href=""MPClient/MyMusicListAlbumsForGenre.aspx?friendly={0}&value={1}&start=0#_MyMusicListAlbumForGenre"" rev=""async"">{1}</a></li>", friendly, filter)
        Next
