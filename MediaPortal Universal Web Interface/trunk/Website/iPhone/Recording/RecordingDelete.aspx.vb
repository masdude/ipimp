...
Partial Public Class RecordingDelete
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        xw.WriteCData(DisplayDeleteRecordingMenu(wa, recordingID))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayDeleteRecordingMenu(ByVal wa As String, ByVal recordingID As String) As String
        ...
        markup += "<div>"
        markup += String.Format("<a href=""Recording/RecordingDeleteResult.aspx?id={0}#_DeleteRecResult{0}"" rev=""async"" rel=""Action"" class=""iButton iBWarn"">{1}</a>", recordingID, GetGlobalResourceObject("uWiMPStrings", "yes"))
