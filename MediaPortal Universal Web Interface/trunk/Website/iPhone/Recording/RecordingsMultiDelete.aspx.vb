...
Partial Public Class RecordingsMultiDelete
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        xw.WriteCData(DisplayRecordingsDeleteMenu(wa, CInt(start)))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayRecordingsDeleteMenu(ByVal wa As String, ByVal start As Integer) As String
        ...
        Dim count As Integer = uWiMP.TVServer.Recordings.GetRecordingCount
        ...
        Dim recordings As List(Of Recording) = uWiMP.TVServer.Recordings.GetRecordings(start, pagesize, "date")
