...
)[0];_b(_bb,f);if(f=f[1]){clearInterval(f[1]);f[0].style.backgroundImage=""}}return h},Player:function(src){if(!_m()){window.open(src)}else{var a=arguments[1];var t=(a&&_tt);if(!t)location="#"+Math.random();var w=$("__wa_media");var o=_Q(t?"embed":"iframe");o.id="__wa_media";o.setAttribute("postdomevents","true");o.src=src;(a||_webapp).appendChild(o);if(t)o.Play();if(w)_R(w)}return false},toString:function(){return "[WebApp.Net Framework]"}}
...
function _t(e){if(_gg)return _K(e);var o=e.target;var n=_T(o);if(n=="label"){var f=$(o.getAttribute("for"));if(_V(f,"iToggle"))A_(_5,1,f.previousSibling.childNodes[1],1);return}
var li=_Z(o,"li");if(li&&_V(li,"iRadio")){_X(li,"__sel");_PP(li);_hh=location.href;_v("wa__radio");return _K(e)}
...
_s(ul,li,!!h,!ax);if(!t)return _K(e)}if(a&&_N(a.id,["waBackButton","waHomeButton"])){if(a.id=="waBackButton")$pc.Back();else $pc.Home();return _K(e)}if(ul&&_V(ul,"iCheck")){if(_OO(a,ul)!==false){var al=$$("li",ul);for(var i=0;i<al.length;i++)_Y(al[i],"__act","__sel");_X(li,"__act __sel");A_(_Y,1000,li,"__sel")}return _K(e)}if(ul&&!_V(li,"iMore")&&((_V(ul,"iMenu")||_V(pr,"iMenu"))||(_V(ul,"iList")||_V(pr,"iList")))){if(a&&!_V(a,"iButton")){var c=_X(li,_V(a,"iSide")?"__tap":"__sel");if(ax){if(!c)_EE(a);return _K(e)}}
}
var dv=_a(o,"iMore");if(dv){if(!_V(dv,"__lod")){$pc.Loader(dv,1);if(ax)_EE(a)}return _K(e)}if(a&&_nn){if(_U(a.rel,"back")){$pc.Form(_nn,a);return _K(e)}if(_U(a.rel,"action")){$pc.Submit(_nn,a,e);return _K(e)}}if(a&&_U(a.rev,"media")){_u(li);$pc.Player(a.href,a);return _K(e)}if(ax){_EE(a);_K(e)}else if(a){var go=_N("#_",a.href);if(go&&!a.target){_opener(a.href);_K(e)}if(!go)_u(li)}}
...
function _z(o,t,i){if(o){if(t)t="translate("+t+",0)";o.style.webkitTransitionProperty=(i)?"none":"";o.style.webkitTransform=t}}
...
A_(function(){_g(dst);_z(dst,"0");_z(src,(g*100)+"%");if(h){hcs.opacity=0;hos.opacity=1;_z(h,(g*30)+"%");_z(_head,"0");_z(_dd[TITLE],"0")}
...
er=(o.status!=200&&o.status!=0);if(!er)try{if(cb)ld=cb(o,lr,_FF())}
