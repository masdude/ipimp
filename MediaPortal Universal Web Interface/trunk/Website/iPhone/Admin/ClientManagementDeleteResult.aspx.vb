...
Partial Public Class ClientManagementDeleteResult
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waClientDelResult"
        ...
        xw.WriteCData(DeleteClient(wa, client))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DeleteClient(ByVal wa As String, ByVal client As uWiMP.TVServer.MPClient.Client) As String
        ...
        If uWiMP.TVServer.MPClientDatabase.ManageClient(client, "delete") Then
