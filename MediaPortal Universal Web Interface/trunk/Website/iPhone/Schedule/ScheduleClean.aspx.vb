...
Partial Public Class ScheduleClean
    ...
    Private Function CleanSchedules(ByVal wa As String) As String
        ...
        markup += "<div>"
        markup += String.Format("<a href=""Schedule/ScheduleCleanResult.aspx#_SchedCleanResult"" rev=""async"" rel=""Action"" class=""iButton iBWarn"">{0}</a>", GetGlobalResourceObject("uWiMPStrings", "yes"))
