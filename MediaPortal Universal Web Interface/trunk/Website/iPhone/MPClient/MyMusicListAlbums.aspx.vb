...
Partial Public Class MyMusicListAlbums
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = String.Format("waMyMusicListAlbums{0}", letter)
        ...
        If start >= pagesize Then
            ...
            xw.WriteAttributeString("zone", "morealbums")
        Else
        ...
        xw.WriteCData(DisplayMyMusicAlbums(friendly, letter, start, pagesize))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayMyMusicAlbums(ByVal friendly As String, _
        ...
        If start = 0 Then
            ...
            markup += String.Format("<h3>{0} - {1}</h3>", friendly, letter)
            markup += "<ul class=""iArrow"">"
            markup += String.Format("<li><a href=""MPClient/MyMusicPlayRandom.aspx?friendly={0}&filter=letter&value={1}#_MPClientPlayRandom"" rev=""async"">{2}</a></li>", friendly, letter, GetGlobalResourceObject("uWiMPStrings", "play_100_random"))
            markup += "</ul>"
            markup += "<ul class=""iArrow"">"
        End If
        ...
        If (start + (pagesize - 1)) < UBound(albums) Then
            markup += String.Format("<li id=""morealbums"" class=""iMore""><a href=""MPClient/MyMusicListAlbums.aspx?friendly={0}&value={1}&start={2}#_MyMusicListAlbums{1}"" rev=""async"" title=""{3}"">{4}</a></li>", friendly, letter, (start + pagesize).ToString, GetGlobalResourceObject("uWiMPStrings", "loading"), GetGlobalResourceObject("uWiMPStrings", "more"))
        End If
