...
Partial Public Class MyMusicListAlbumsForGenre
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim genre As String = Request.QueryString("value")
        ...
        Dim wa As String = "waMyMusicListAlbumForGenre"
        ...
        If start >= pagesize Then
            ...
            xw.WriteAttributeString("zone", "morealbumsgenre")
        Else
