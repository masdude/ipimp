...
Partial Public Class MyMusicListTracksForArtist
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waMyMusicListTracksForArtist"
        ...
        If start >= pagesize Then
            ...
            xw.WriteAttributeString("zone", "moretracks")
        Else
    ...
    Private Function DisplaySongs(ByVal wa As String, _
        ...
        If start = 0 Then
            ...
            markup += String.Format("<h3>{0}</h3>", artist)
            ...
            markup += String.Format("<li><label>{0}</label><input type=""checkbox"" id=""jsShuffleArtist"" class=""iToggle"" title=""{1}"" /></li>", GetGlobalResourceObject("uWiMPStrings", "shuffle"), GetGlobalResourceObject("uWiMPStrings", "yesno"))
            markup += String.Format("<li><label>{0}</label><input type=""checkbox"" id=""jsEnqueueArtist"" class=""iToggle"" title=""{1}"" /></li>", GetGlobalResourceObject("uWiMPStrings", "enqueue"), GetGlobalResourceObject("uWiMPStrings", "yesno"))
            markup += "</ul>"
        ...
        If UBound(tracks) > 0 Then markup += String.Format("<li id=""moretracks"" class=""iMore""><a href=""MPClient/MyMusicListTracksForArtist.aspx?friendly={0}&artist={1}&start={2}#_MyMusicListTracksForArtist"" rev=""async"" title=""{3}"">{4}</a></li>", friendly, artist, (start + pagesize).ToString, GetGlobalResourceObject("uWiMPStrings", "loading"), GetGlobalResourceObject("uWiMPStrings", "more"))
