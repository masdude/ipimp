...
Partial Public Class MovingPicturesListYears
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waMovingPicturesListYears"
        ...
        xw.WriteCData(DisplayMovingPicturesYears(friendly, decade))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayMovingPicturesYears(ByVal friendly As String, ByVal decade As String) As String
        ...
        For Each filter As String In filters
            If filter <> "" Then markup += String.Format("<li><a href=""MPClient/MovingPicturesList.aspx?friendly={0}&filter=year&value={1}&start=0#_MovingPicturesMovies{1}"" rev=""async"">{1}</a></li>", friendly, filter)
        Next
