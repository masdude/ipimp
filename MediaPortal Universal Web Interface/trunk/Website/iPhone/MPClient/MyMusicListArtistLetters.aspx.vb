...
Partial Public Class MyMusicListArtistLetters
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim wa As String = "waMyMusicListArtists"
        ...
        xw.WriteCData(DisplayMyMusicArtists(friendly))
        xw.WriteEndElement()
        'end data
    ...
    Private Function DisplayMyMusicArtists(ByVal friendly As String) As String

        Dim markup As String = String.Empty
        Dim mpRequest As New uWiMP.TVServer.MPClient.Request
        mpRequest.Action = "getmusicfilter"
        mpRequest.Filter = "artistletter"
        ...
        Dim ja As JsonArray = CType(jo("artistletter"), JsonArray)
        ...
        For Each filter As String In filters
            If filter <> "" Then markup += String.Format("<li><a href=""MPClient/MyMusicListArtists.aspx?friendly={0}&value={1}&start=0#_MyMusicListArtists{1}"" rev=""async"">{1}</a></li>", friendly, filter)
        Next
