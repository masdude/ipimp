...
Partial Public Class TVChannel
    ...
    Private Function DisplayChannelMenu(ByVal channelID As String) As String
        ...
        For i As Integer = 2 To CInt(uWiMP.TVServer.Utilities.GetAppConfig("GUIDEDAYS")) - 1
            markup += String.Format("<li><a href=""TVGuide/TVChannelDay.aspx?channel={0}&day={1}#_Channel{0}Day{1}"" rev=""async"">{2}</a></li>", channelID, i.ToString, StrConv(Now.AddDays(i).ToString("dddd"), vbProperCase))
        Next
