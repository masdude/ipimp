...
<body>
    <form id="form1" runat="server">
        ...
        <li class="orange"><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6722080" target="_blank"><asp:Literal ID="Literal13" runat="server" Text="<%$ Resources:uWiMPStrings, donate %>" /></a></li>
        </ul>
        </div>
