        ...
        <asp:Table ID="Table1" runat="server" HorizontalAlign="Center">
            ...
            <asp:TableRow ID="TableRow2" runat="server" HorizontalAlign="Center">
                <asp:TableCell ID="TableCell2" runat="server">
                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:uWiMPStrings, username %>" CssClass="largeblack" />&nbsp;
                    <asp:TextBox ID="Username" runat="server"  CssClass="largeblack" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow3" runat="server" HorizontalAlign="Center">
                <asp:TableCell ID="TableCell3" runat="server" >
                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:uWiMPStrings, password %>" CssClass="largeblack" />&nbsp;
                    <asp:TextBox ID="Password" runat="server" TextMode="Password"  CssClass="largeblack" />
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow ID="TableRow5" runat="server" HorizontalAlign="Center">
                <asp:TableCell ID="TableCell5" runat="server">
                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:uWiMPStrings, remember_me %>" CssClass="largeblack" />&nbsp;
                    <asp:CheckBox ID="CheckBox1" runat="server" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow6" runat="server" HorizontalAlign="Center">
                <asp:TableCell ID="TableCell6" runat="server">
                    <asp:Button ID="Button1" runat="server" Text="<%$ Resources:uWiMPStrings, login %>" CommandName="login" CssClass="button" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
